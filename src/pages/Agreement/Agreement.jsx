  ...
  return (
    <S.Agree_container>
      ...
      <S.Agree_box>
        <S.Agreement_wrap>
          <S.Agree_btn
            className={`${isAllClicked ? 'clicked' : ''}`}
            onClick={allCheckBtnClick}
          >
            <S.Agree_check
              src={Agreement_Check}
              className={`${isAllClicked ? 'clicked' : ''}`}
          ...
          <S.Agree_text
            className={`agree_text ${isAllClicked ? 'clicked' : ''}`}
          >
            약관 전체 동의
          </S.Agree_text>
        </S.Agreement_wrap>
        ...
        <div>
          <S.Agreement_wrap>
            ...
            <S.Agree_text className={`${isClicked1 ? 'clicked' : ''}`}>
              이용약관 동의 (필수)
            </S.Agree_text>
          ...
          <S.Agreement_wrap>
            ...
            <S.Agree_text className={`${isClicked2 ? 'clicked' : ''}`}>
              개인정보 수집 및 이용동의 (필수)
            </S.Agree_text>
          ...
          <S.Agreement_wrap>
            ...
            <S.Agree_text className={`${isClicked3 ? 'clicked' : ''}`}>
              만 14세 이상입니다 (필수)
            </S.Agree_text>
            <S.Agree_arrow src={Agreement_Arrow} />
          </S.Agreement_wrap>
